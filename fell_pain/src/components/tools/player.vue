<style lang="less">
#player-vue-id {
  box-sizing: border-box;width: 100%;height: 100%;padding: 0 10px;
  ...
  &.type-1 {
    .video-wrapper {
      position: fixed;z-index: 90;top: 35px;right: 10px;left: 10px;display: block;height: 150px;
    }
  ...
  .video-wrapper {
    height: 250px;padding-top: 10px;background-color: #fff;
  }
  ...
  .list-wrapper {
    ...
    .move {
      &.active {
        .mint-cell-wrapper {
          border-bottom: none;background-color: #7ce7ff;
        }
      }
    }
  }
